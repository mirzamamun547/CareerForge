<x-guest-layout>
    <x-slot name="title">Employer Login - CareerForge</x-slot>
    ...
    <div class="auth-card rounded-3xl p-8 sm:p-10">
        ...
        <div class="text-center mb-8">
            ...
            <h2 class="text-2xl font-extrabold text-[#0f172a] tracking-tight mt-6">Employer Login</h2>
            <p class="text-sm text-[#64748b] font-semibold mt-1">Login to your employer account</p>
        </div>
